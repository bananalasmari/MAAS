otp.config = {
    ...
    initLatLng : new L.LatLng(24.46789, 39.60987),
    initZoom : 14,
    // minZoom : 10,
    // maxZoom : 20,
    ...
    // siteName            : "Saudi Journy Planner",
    siteDescription     : "An OpenTripPlanner deployment.",
    logoGraphic         : 'images/MASS_2.png',
    // bikeshareName    : "",
    ...
    infoWidgetLangChooser : {
        title: '<img src="images/language_icon.svg" onerror="this.onerror=\'\';this.src=\'images/language_icon.png\'" width="20px" height="20px"/>', 
        languages: true
    },
...
i18n.init(options, function(t) {
    ...
    if ("infoWidgets" in otp.config.locale) {
        ...
        otp.config.infoWidgets=otp.locale.Arabic.infoWidgets;
    }
